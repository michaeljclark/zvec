...
datasets = [
    ...
    'synth_con_mib_sec',
    'synth_seq_mib_sec',
    'encode_rel_8_mib_sec',
    'decode_rel_8_mib_sec',
    'encode_rel_16_mib_sec',
    'decode_rel_16_mib_sec',
    'encode_rel_24_mib_sec',
    'decode_rel_24_mib_sec',
    'encode_rel_32_mib_sec',
    'decode_rel_32_mib_sec',
    'encode_rel_48_mib_sec',
    'decode_rel_48_mib_sec',
    'encode_abs_8_mib_sec',
    'decode_abs_8_mib_sec',
    'encode_abs_16_mib_sec',
    'decode_abs_16_mib_sec',
    'encode_abs_24_mib_sec',
    'decode_abs_24_mib_sec',
    'encode_abs_32_mib_sec',
    'decode_abs_32_mib_sec',
    'encode_abs_48_mib_sec',
    'decode_abs_48_mib_sec'
]
